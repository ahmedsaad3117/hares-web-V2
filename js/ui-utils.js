...
(function (global) {
  ...
  async function openHelpModal() {
    ...
    if (isSuperAdmin) {
      ...
      modalContent = `
      <div class="form-group help-field mb-4">
        <label class="label">${t('help.whatsapp_label')}</label>
        <div class="help-input-wrap">
          <span class="help-input-icon" aria-hidden="true">✆</span>
          <input type="tel" inputmode="tel" autocomplete="tel" id="supportWhatsapp" class="input help-input" value="${supportInfo.whatsapp || ''}" placeholder="e.g. 966500000000">
        </div>
      ...
      <div class="form-group help-field mb-4">
        ...
        <div class="help-input-wrap">
          <span class="help-input-icon help-input-icon-email" aria-hidden="true">@</span>
          <input type="email" inputmode="email" autocomplete="email" id="supportEmail" class="input help-input" value="${supportInfo.email || ''}" placeholder="support@domain.com">
        </div>
      </div>
    `;
    } else {
      ...
      <div class="help-contact-actions">
        ${supportInfo.whatsapp ? `
          <a href="https://wa.me/${supportInfo.whatsapp}" target="_blank" class="btn btn-whatsapp help-contact-button">
        ...
        ${supportInfo.email ? `
          <a href="mailto:${supportInfo.email}" class="btn btn-primary help-contact-button">
